;(function () {
	...
	if ( $(window).scrollTop() > amountScrolled ) {
		$('#colorlib-page button.back-to-top').addClass('show');
	} else {
		$('#colorlib-page button.back-to-top').removeClass('show');
	}
	});

	$('#colorlib-page button.back-to-top').click(function() {
	$('html, body').animate({
		scrollTop: 0
	}, 1000);
	return false;
	...
	// Add waves effect
	Waves.attach('#colorlib-page button.back-to-top', 'waves-effect');
	Waves.init();
